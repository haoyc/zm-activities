    ...
    <div class="agent_self">
        ...
        <div class="content">
            <el-table :data="tableData" border stripe style="width: 100%" v-loading="loading" >
                ...
                <el-table-column prop="area" label="区县" min-width="180" align="center"/>
                <el-table-column prop="registerTime" label="注册时间" min-width="200" align="center">
                    <template slot-scope="scope">
                        <i class="el-icon-time" v-if="scope.row.registerTime" />
                        <span style="margin-left: 10px">{{ setTime(scope.row.registerTime) }}</span>
                    </template>
                </el-table-column>
                <el-table-column prop="cardCode" label="代理卡号" min-width="180" align="center"/>
                <el-table-column prop="activeTime" label="激活时间" min-width="200" align="center">
                    <template slot-scope="scope">
